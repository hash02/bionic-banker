...
const required = [
  ...
  ['home', 'AI is entering finance. Bionic Banker shows how to use it safely.'],
  ['home', 'It studies how AI can help banks and crypto companies catch fraud, check risky wallets, and review money movement while keeping humans in charge.'],
  ['home', 'We test AI finance workflows, explain fraud and AML in plain language, and show what AI must not decide alone.'],
